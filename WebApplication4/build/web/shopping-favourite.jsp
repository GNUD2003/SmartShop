...
<html lang="zxx">
    ...
    <body>
        ...
        <section class="breadcrumb-section set-bg" data-setbg="img/pngtree-dark-green-background-and-yellow-eps-hd-free-download-pngtree-image_736895.jpg">
            <div class="container">
                <div class="row">
        ...
        <section class="shoping-cart spad">
            <div class="container">
                <c:choose>
                    <c:when test="${sessionScope.favourites == null || sessionScope.favourites.size() == 0}">
                        <h1>List favourite is empty!</h1>
                    </c:when>
                    <c:otherwise>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="shoping__cart__table">
                                    <table>
                                        ...
                                        <tbody>
                                            <tr>
                                                <c:forEach items="${favourites}" var="C">
                                                <td class="shoping__cart__item">
                                                    <img src="${C.product.imgPath}" alt="">
                                                    <h5>${C.product.imgPath.product_Name}</h5>
                                                </td>
                                                <td class="shoping__cart__price">
                                                    ${C.product.imgPath.price}
                                                </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="shoping__checkout">
                                    <h5>Favourite Total</h5>
                                    <ul>

                                        <li>Total <span></span></li>
                                    </ul>
                                    <a href="#" class="primary-btn">PROCEED TO REGISTRATION </a>
                                </div>
                            </div>
                        </div>
                    </c:otherwise>
