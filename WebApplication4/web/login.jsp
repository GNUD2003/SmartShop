        ...
        <section class="vh-100" style="background-color: #9A616D;">
            <div class="container py-5 h-100">
                <div class="row d-flex justify-content-center align-items-center h-100" >
                    <div class="col col-xl-10" style="margin-top: -45px;">
                        <div class="card" style="border-radius: 1rem;">
                            <div class="row g-0">
                                <div class="col-md-6 col-lg-5 d-none d-md-block" style="height: 100%;">
                                    <img 
                                        src="img/azvector181100097.jpg"
                                        alt="login form"
                                        class="img-fluid" style="border-radius: 1rem 0 0 1rem;"
                                         style="border-radius: 1rem 0 0 1rem; width: 100px; height: 1000px;"
                                        />
                                </div>
                                    ...
                                    <div class="card-body p-4 p-lg-5 text-black">
                                        <form action="LoginController" method="POST">
                                            <div class="d-flex align-items-center mb-3 pb-1 default-cursor">
                                                ...
                                                <span class="h1 fw-bold mb-0" style="color: red">G-STORE</span>
                                            </div>
