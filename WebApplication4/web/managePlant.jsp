                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span>
                                                        ...
                                                        <button type="button" class="btn btn-outline-danger w-100" data-bs-toggle="modal" data-bs-target="#blockBtnd${LP.id}">
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="blockBtnd${LP.id}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                    ...
                                                                    <div class="p-4 text-center fs-3" style="color: red;">
                                                                        Are you sure you want to remove plant <span class="text-dark">${LP.name}</span> from your store?
                                                                    </div>
                                                                    
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                                        <form action="deletePlant?pid=${LP.id}" method="POST">
