    ...
    <div class="container-menu-desktop">
        ...
        <div class="top-bar">
            <div class="content-topbar flex-sb-m h-full container">
                ...
                <div class="right-top-bar flex-w h-full">
                    <a class="text-decoration-none flex-c-m trans-04 p-lr-25" href="#"><i class="bi bi-phone me-2"></i>+84 0373154212</a>
                    <a class="text-decoration-none flex-c-m trans-04 p-lr-25" href="#"><i class="bi bi-envelope me-2"></i>dungnmhe176353@fpt.edu.vn</a>
                    <a href="https://www.facebook.com/profile.php?id=100056112458895" class="flex-c-m trans-04 p-lr-25"><i class="bi bi-facebook"></i></a>
                    <a href="#" class="flex-c-m trans-04 p-lr-25"><i class="bi bi-twitter"></i></a>
                    <a href="https://www.instagram.com/nguyen261m/" class="flex-c-m trans-04 p-lr-25"><i class="bi bi-instagram"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="wrap-menu-desktop">
            <nav class="limiter-menu-desktop container">
                ...
                <img src="./img/default-team.png" alt="IMG-LOGO">
            </a>
...
<div class="wrap-header-mobile">
    ...
    <div class="logo-mobile">
        <a href="${homeUrl}"><img src="./img/channels4_profile.jpg" alt="IMG-LOGO"></a>
    </div>
